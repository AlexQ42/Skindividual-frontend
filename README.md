...
The website's frontend is written in JavaScript as a single-page-application using the React framework and Bootstrap. The design was developed and tested as a Figma prototype before implementing.
